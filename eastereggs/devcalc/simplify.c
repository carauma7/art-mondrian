/***********************************************************************
 * 
 * simplify.c | "Funções pertencentes às simplificações matemáticas."
 * 
...
char *simp_input(char *str) {
    ...
    /* inicia removendo os parênteses fechados */
    ...
    return rt_str; // num_tm/num_bl já contemplam todos os casos
}
